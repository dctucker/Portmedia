...
public:
	...
	virtual operator double (){ return val; }
	virtual operator const char *(){
		sprintf( str, "%4.0f", val );
		return str;
	}
};
...
protected:
	Value numer, denom;
public:
	Fraction(Value n, Value d) : numer(n), denom(d) {}
	operator double (){
		val = numer / denom;
		return val;
	}
	operator const char*(){
		sprintf( str, "(%s / %s)", (const char *)numer, (const char *)denom );
		return str;
	}
};
...
protected:
	Value base, expo;
public:
	Power(Value b, Value e) : base(b), expo(e) {}
	operator double(){
		val = pow(base, expo);
		return val;
	}
	operator const char*(){
		sprintf( str, "(%s ^ %s)", (const char *)base, (const char *)expo );
		return str;
	}
};
...
(2^1/1200:1)	1.00	cent
(2^1/1000:1)	1.20	millioctave
...
(3⁵³:2⁸⁴)	3.6	Mercator's comma, the ratio of 53 pure thirds to 31 octaves
(10^1/1000:1)	3.99	Savart
...
(81:80)	21.506	major comma, syntonic comma, comma of Didymus (difference between four justly tuned perfect fifths and two octaves plus a major third) - There are 55.79763 syntonic commas in the octave
(2^1/53:1)	22.64	Arabian comma, Holdrian comma or Holder's comma
(531441:524288)	23.460	Pythagorean or ditonic comma (312/219) (difference between twelve justly tuned perfect fifths and seven octaves) - There are 51.15087 Pythagorean commas in the octave
...
(2^1/24:1)	50.00	equal-tempered quarter tone
...
(55:52)	97.104	 
(128:121)	97.364	 
(18:17)	98.955	equal temperament (ET) semitone (half-step) (approximation familiar to makers of lutes, who used it when fixing frets on lute fingerboards)
(2^1/12:1)	100.000	equal temperament (ET) semitone (half-step), equal-tempered minor second, exact
(35:33)	101.867	 
(52:49)	102.876	 
(86:81)	103.698	 
...
(2187:2048)	113.685	apotome or apotome Pythagorica, Pythagorean major semitone, Pythagorean chromatic semitone the difference between a Pythagorean diatonic semitone and a Pythagorean chromatic semitone is the Pythagorean or ditonic comma
(31:29)	115.458	 
(77:72)	116.234	 
...
(135:124)	147.143	 
(49:45)	147.428	 
(2^3/24:1)	150.000	Equal tempered Neutral second
